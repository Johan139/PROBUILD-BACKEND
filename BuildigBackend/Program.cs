...
using BuildigBackend.Infrastructure;
        ...
        policy =>
        {
            policy
                .SetIsOriginAllowed(origin =>
                    ...
                    || origin == "https://app.buildig.ai"
                    || origin == "https://www.app.buildig.ai"
                    || origin == "https://buildig.ai"
                    || origin == "https://app.buildig.com"
                    || origin == "https://www.app.buildig.com"
...
builder.Services.AddScoped<IJobSubtaskTimelineSyncService, JobSubtaskTimelineSyncService>();
...
builder.Services.AddScoped<ChatKnowledgeResolverService>();
...
app.Logger.LogInformation(
    ...
    $"Buildig-Hangfire-Server:{Environment.MachineName}:{System.Diagnostics.Process.GetCurrentProcess().Id}"
);
...
try
{
    ...
    var testType = typeof(BuildigBackend.Services.EmailAutomationManager);
    app.Logger.LogInformation(
