...
namespace ProbuildBackend.Controllers
{
    ...
    public class RatingsController : ControllerBase
    {
        ...
        public RatingsController(ApplicationDbContext context, UserModerationService userModerationService)
        {
            _context = context;
        ...
        public async Task<IActionResult> CreateRating([FromBody] RatingDto ratingDto)
        {
            ...
            return CreatedAtAction(nameof(GetRatingsForUser), new { userId = rating.RatedUserId }, rating);
        }
