...
namespace ProbuildBackend.Interface
{
    public interface IAiService
    {
        ...
        Task<string> AnalyzePageWithAssistantAsync(
            byte[] imageBytes,
            int pageIndex,
            string blobUrl,
            JobModel job
        ...
        Task<string> PerformMultimodalAnalysisAsync(
            IEnumerable<string> fileUris,
            string prompt,
            bool isAnalysis = false
        );
        IAsyncEnumerable<string> StreamTextResponseAsync(
            string conversationId,
            string prompt,
            List<string> files
        );
        Task<(string initialResponse, string conversationId)> StartMultimodalConversationAsync(
            string userId,
            IEnumerable<string> documentUris,
        ...
        Task<(string response, string conversationId)> StartTextConversationAsync(
            string userId,
            string systemPersonaPrompt,
            string initialUserPrompt,
            string? conversationId = null
